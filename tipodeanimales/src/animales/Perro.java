...
abstract public class Perro extends Canino{
    ...
    public String correr() {
        return "El perro africano corre en la sabana africana!";
    }

    @Override
    public String comunicarse() {
        return "Los perros ladran siempre y cuando llegue una persona extraña";
    }
}
