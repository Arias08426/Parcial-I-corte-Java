...
abstract public class Lobo extends Canino{
    ...
    public String dormir() {
        return "El Lobo " + color + " duerme en las dcabernas de " + habitad;
    }
    ...
    public String comunicarse() {
        return "El Lobo " + especieLobo + " " + color + " aulla cuando hay luna llena";
    }
}
